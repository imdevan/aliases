...
// TODO: likely need shell specific reserved lists
...
func (m *Manager) generateShellScript(bookmarks []domain.Bookmark) error {
	...
	script.WriteString("# Clean up any bad aliases that break shell parsing\n")
	script.WriteString("unalias fi 2>/dev/null\n\n")
